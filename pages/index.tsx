      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 font-sans">
        <main className="space-y-12">
          ...
          <Section title={content.education.title}>
                ...
                {content.education.list.slice(0, 4).map((edu: Education, index: number) => (
                   ...
                   <div className="ml-6 flex-1">
                      <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                         ...
                         <p className="text-base text-slate-500 font-mono mb-1">{edu.year}</p>
                         {edu.supervisor && (
                            <p className="text-base text-slate-500 italic">{edu.supervisor}</p>
                         )}
                      </div>
                   </div>
                   </div>
             ...
             <h3 className="text-2xl font-bold text-slate-800 mt-8 mb-6 border-t pt-6">{content.education.overseasTitle}</h3>
             <div className="space-y-6">
                {content.education.overseasList.map((edu: Education, index: number) => (
                     <div key={index} className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                        ...
                        <p className="text-lg text-slate-600 mb-2">{edu.institution}</p>
                        <p className="text-base text-slate-500 font-mono mb-1">{edu.year}</p>
                        {edu.supervisor && <p className="text-base text-slate-500 italic mt-1">{edu.supervisor}</p>}
                    </div>
                ))}
             </div>
          </Section>
          ...
          <Section title={content.achievements.title}>
            {/* Journal Papers */}
            <div className="mb-8">
                <h3 className="text-2xl font-semibold text-slate-800 mb-6">{content.achievements.journalPapers.title}</h3>
            ...
            <div className="mb-8 pt-6 border-t">
                <h3 className="text-2xl font-semibold text-slate-800 mb-6">{content.achievements.patents.title}</h3>
                <FoldableList
            ...
            {/* Software Copyrights */}
            <div className="mb-8 pt-6 border-t">
                <h3 className="text-2xl font-semibold text-slate-800 mb-6">{content.achievements.softwareCopyrights.title}</h3>
                <FoldableList
            ...
            <div className="pt-6 border-t">
                <h3 className="text-2xl font-semibold text-slate-800 mb-6">{content.achievements.monographs.title}</h3>
                <div className="space-y-8">
          ...
          <Section title={content.projects.title}>
            <h3 className="text-2xl font-semibold text-slate-800 mb-6">{content.projects.vertical}</h3>
            <FoldableList
                ...
                buttonTexts={{ showMore: content.achievements.showMore, showLess: content.achievements.showLess }}
            />
            <h3 className="text-2xl font-semibold text-slate-800 mb-6 border-t pt-6">{content.projects.horizontal}</h3>
            <div className="space-y-8">
               <FoldableList
          ...
          <Section title={content.experience.title}>
            <div className="space-y-8">
              {content.experience.list.map((exp: Experience, index: number) => (
                <div key={index} className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                  <h3 className="text-xl font-semibold text-slate-900 mb-2">{exp.role}</h3>
                  <div className="text-lg text-slate-600 mb-3 flex flex-wrap gap-x-4">
